package com.zwj.user.controller;

import com.zwj.thrift.user.UserInfo;
import com.zwj.thrift.user.dto.UserDTO;
import com.zwj.user.redis.RedisClient;
import com.zwj.user.response.LoginResponse;
import com.zwj.user.response.Response;
import com.zwj.user.thrift.ServiceProvider;
    ...
    public Response register(@RequestParam("username")String username,
        ...
        if (StringUtils.isNotBlank(mobile)) {
            ...
            if (!verifyCode.equals(verifyCode)) {
                return Response.VARIFY_CODE_INVALID;
            }
        }else {
